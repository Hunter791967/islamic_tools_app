...
class CustomTitle extends StatelessWidget {
  const CustomTitle({super.key, this.quranChapter, this.hadeethChapter});
  ...
  Widget build(BuildContext context) {
    ...
    // String displayTitle =
    //     quranChapter != null ? quranChapter!.quranListName : 'hadeeth_tab.hadeeth'.tr();
    // 👈 current app locale
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Text(
                    quranChapter != null
                        ? quranChapter!.quranListName
                        : 'hadeeth_tab.hadeeth_no'.tr(),
                    //displayTitle,
                  ...
                  child: CircleAvatar(
                    ...
                    child: Text( isArabic ?
                      convertToArabicNumber(quranChapter?.quranListNumber ??
                        ...
                        : (quranChapter?.quranListNumber ??
                        hadeethChapter?.hadeethListNumber ?? 0).toString(),
                      style: TextStyle(
                        fontFamily: 'kofi',
                        fontSize: 16,
